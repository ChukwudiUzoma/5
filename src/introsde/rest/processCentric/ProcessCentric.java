...
public class ProcessCentric {
    ...
    public Response updateHP(LifeStatus ls) throws IOException {
        ...
        //String ENDPOINT = "http://10.218.200.46:5900/introsde/storage/updateHP/1";
        String ENDPOINT = "https://storag.herokuapp.com/introsde/storage/updateHP/1";
        ...
        //String ENDPOINT2 = "http://10.218.200.46:5500/introsde/businessLogic/compare/"+ls.getMeasureName();
        String ENDPOINT2 = "https://buslogic.herokuapp.com/introsde/businessLogic/compare/"+ls.getMeasureName();
        ...
        public Response updateGoal(Goal goal) throws IOException {
            ...
            //Update goal
            //String ENDPOINT = "http://10.218.200.46:5900/introsde/storage/updateGoal";
        	String ENDPOINT = "https://storag.herokuapp.com/introsde/storage/updateGoal";
            ClientConfig clientConfig = new ClientConfig();
            Client client = ClientBuilder.newClient(clientConfig);
      ...
      //Getting a motivation quote from quotedesign
        ...
        public Response getQuote() throws ClientProtocolException, IOException {
        	...
        	//String ENDPOINT = "http://10.218.200.46:5900/introsde/storage/getQuoteMotivation";
        	String ENDPOINT = "https://storag.herokuapp.com/introsde/storage/getQuoteMotivation";
        ...
        public Response getQuote2() throws ClientProtocolException, IOException {
        	...
        	//String ENDPOINT = "http://10.218.200.46:5900/introsde/storage/getQuoteMotivation2";
        	String ENDPOINT = "https://storag.herokuapp.com/introsde/storage/getQuoteMotivation2";
        	DefaultHttpClient client = new DefaultHttpClient();
        	HttpGet request = new HttpGet(ENDPOINT);
        	HttpResponse response = client.execute(request);
